...
func (h *HeimdallClient) FetchCheckpoint(number int64) (*checkpoint.Checkpoint, error) {
...
func (h *HeimdallClient) FetchCheckpointCount() (int64, error) {
	...
	response, err := FetchWithRetry[checkpoint.CheckpointCountResponse](h.client, url, h.closeCh)
	if err != nil {
		return 0, err
	}
