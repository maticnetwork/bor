...
func (gc *GenesisContractsClient) CommitState(
	...
	method := "commitState"
	data, err := gc.stateReceiverABI.Pack(method, recordBytes, event.Time.Unix())
	if err != nil {
