...
wait_for_log bor-a "Bulk sidecar channel opened.*snap-accounts"
wait_for_log bor-b "Bulk sidecar channel opened.*snap-accounts"
wait_for_log bor-a "Bulk sidecar channel opened.*snap-storage"
wait_for_log bor-b "Bulk sidecar channel opened.*snap-storage"
wait_for_log bor-a "Bulk sidecar channel opened.*snap-code"
wait_for_log bor-b "Bulk sidecar channel opened.*snap-code"
wait_for_log bor-a "Bulk sidecar channel opened.*snap-trie"
wait_for_log bor-b "Bulk sidecar channel opened.*snap-trie"
