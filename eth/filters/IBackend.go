...
func (mr *MockBackendMockRecorder) GetBorBlockLogs(ctx, blockHash any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBackendMockRecorder) GetBorBlockReceipt(ctx, blockHash any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
