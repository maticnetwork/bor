...
func (m *MockBackend) CheckPreconfStatus(hash common.Hash) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CheckPreconfStatus", hash)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockBackendMockRecorder) CheckPreconfStatus(hash any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckPreconfStatus", reflect.TypeOf((*MockBackend)(nil).CheckPreconfStatus), hash)
}
...
func (m *MockBackend) GetFinalizedBlockNumber(ctx context.Context) (uint64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetFinalizedBlockNumber", ctx)
	ret0, _ := ret[0].(uint64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockBackendMockRecorder) GetFinalizedBlockNumber(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetFinalizedBlockNumber", reflect.TypeOf((*MockBackend)(nil).GetFinalizedBlockNumber), ctx)
}
...
func (m *MockBackend) PurgePrivateTx(hash common.Hash) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "PurgePrivateTx", hash)
}

// PurgePrivateTx indicates an expected call of PurgePrivateTx.
func (mr *MockBackendMockRecorder) PurgePrivateTx(hash any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PurgePrivateTx", reflect.TypeOf((*MockBackend)(nil).PurgePrivateTx), hash)
}
...
func (m *MockBackend) RecordPrivateTx(hash common.Hash) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "RecordPrivateTx", hash)
}

// RecordPrivateTx indicates an expected call of RecordPrivateTx.
func (mr *MockBackendMockRecorder) RecordPrivateTx(hash any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RecordPrivateTx", reflect.TypeOf((*MockBackend)(nil).RecordPrivateTx), hash)
}
...
func (m *MockBackend) SubmitHashrate(rate hexutil.Uint64, id common.Hash) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SubmitHashrate", rate, id)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockBackendMockRecorder) SubmitHashrate(rate, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SubmitHashrate", reflect.TypeOf((*MockBackend)(nil).SubmitHashrate), rate, id)
}

// SubmitPrivateTx mocks base method.
func (m *MockBackend) SubmitPrivateTx(tx *types.Transaction) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SubmitPrivateTx", tx)
	ret0, _ := ret[0].(error)
	return ret0
}

// SubmitPrivateTx indicates an expected call of SubmitPrivateTx.
func (mr *MockBackendMockRecorder) SubmitPrivateTx(tx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SubmitPrivateTx", reflect.TypeOf((*MockBackend)(nil).SubmitPrivateTx), tx)
}

// SubmitTxForPreconf mocks base method.
func (m *MockBackend) SubmitTxForPreconf(tx *types.Transaction) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SubmitTxForPreconf", tx)
	ret0, _ := ret[0].(error)
	return ret0
}

// SubmitTxForPreconf indicates an expected call of SubmitTxForPreconf.
func (mr *MockBackendMockRecorder) SubmitTxForPreconf(tx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SubmitTxForPreconf", reflect.TypeOf((*MockBackend)(nil).SubmitTxForPreconf), tx)
}

// SubmitWork mocks base method.
func (m *MockBackend) SubmitWork(nonce types.BlockNonce, hash, digest common.Hash) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SubmitWork", nonce, hash, digest)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockBackendMockRecorder) SubmitWork(nonce, hash, digest any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SubmitWork", reflect.TypeOf((*MockBackend)(nil).SubmitWork), nonce, hash, digest)
}
...
func (m *MockBackend) TxStatus(hash common.Hash) txpool.TxStatus {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TxStatus", hash)
	ret0, _ := ret[0].(txpool.TxStatus)
	return ret0
}

// TxStatus indicates an expected call of TxStatus.
func (mr *MockBackendMockRecorder) TxStatus(hash any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TxStatus", reflect.TypeOf((*MockBackend)(nil).TxStatus), hash)
}
