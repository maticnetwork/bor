...
// GetVoteOnRootHash mocks base method.
func (m *MockBackend) GetVoteOnRootHash(arg0 context.Context, arg1, arg2 uint64, arg3, arg4 string) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetVoteOnRootHash", arg0, arg1, arg2, arg3, arg4)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetVoteOnRootHash indicates an expected call of GetVoteOnRootHash.
func (mr *MockBackendMockRecorder) GetVoteOnRootHash(arg0, arg1, arg2, arg3, arg4 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetVoteOnRootHash", reflect.TypeOf((*MockBackend)(nil).GetVoteOnRootHash), arg0, arg1, arg2, arg3, arg4)
}
