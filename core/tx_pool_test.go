...
//nolint:thelper
func mining(tb testing.TB, pool *TxPool, signer types.Signer, baseFeeU *uint256.Int, blockGasLimit uint64, totalBlocks int) (int, time.Duration, time.Duration) {
	var (
		localTxsCount  int
		remoteTxsCount int
		localTxs       = make(map[common.Address]types.Transactions)
