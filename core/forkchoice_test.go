...
func newChainValidatorFake(validate func(currentHeader *types.Header, chain []*types.Header) (bool, bool, error)) *chainValidatorFake {
...
func (w *chainValidatorFake) IsValidChain(current *types.Header, headers []*types.Header) (bool, bool, error) {
