...
var file_command_server_proto_server_proto_goTypes = []interface{}{
	...
	(*PprofResponse_Open)(nil),     // 17: proto.PprofResponse.Open
	(*PprofResponse_Input)(nil),    // 18: proto.PprofResponse.Input
	nil,                            // 19: proto.PprofResponse.Open.HeadersEntry
...
var file_command_server_proto_server_proto_depIdxs = []int32{
	...
	17, // 6: proto.PprofResponse.open:type_name -> proto.PprofResponse.Open
	18, // 7: proto.PprofResponse.input:type_name -> proto.PprofResponse.Input
	20, // 8: proto.PprofResponse.eof:type_name -> google.protobuf.Empty
	19, // 9: proto.PprofResponse.Open.headers:type_name -> proto.PprofResponse.Open.HeadersEntry
	14, // 10: proto.Bor.Pprof:input_type -> proto.PprofRequest
	...
	20, // 16: proto.Bor.Status:input_type -> google.protobuf.Empty
	15, // 17: proto.Bor.Pprof:output_type -> proto.PprofResponse
	2,  // 18: proto.Bor.PeersAdd:output_type -> proto.PeersAddResponse
	4,  // 19: proto.Bor.PeersRemove:output_type -> proto.PeersRemoveResponse
	6,  // 20: proto.Bor.PeersList:output_type -> proto.PeersListResponse
	8,  // 21: proto.Bor.PeersStatus:output_type -> proto.PeersStatusResponse
	11, // 22: proto.Bor.ChainSetHead:output_type -> proto.ChainSetHeadResponse
	12, // 23: proto.Bor.Status:output_type -> proto.StatusResponse
