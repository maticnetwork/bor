...
func (c Config) MarshalTOML() (interface{}, error) {
	...
	enc.Logger = c.Logger
	enc.TxArrivalWait = c.TxArrivalWait
	enc.TxAnnouncementOnly = c.TxAnnouncementOnly
	return &enc, nil
}
...
func (c *Config) UnmarshalTOML(unmarshal func(interface{}) error) error {
	...
	if dec.TxArrivalWait != nil {
		c.TxArrivalWait = *dec.TxArrivalWait
	}
	if dec.TxAnnouncementOnly != nil {
		c.TxAnnouncementOnly = *dec.TxAnnouncementOnly
	}
	return nil
}
