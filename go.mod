...
replace github.com/btcsuite/btcd/btcec/v2@v2.1.2 => ./vendor_local/btcec // v2.1.2

replace github.com/btcsuite/btcd/btcec/v2/ecdsa => ./vendor_local/btcec/ecdsa // v2.1.2

replace github.com/btcsuite/btcd@v0.20.1-beta => ./vendor_local/btcd

replace github.com/btcsuite/btcd@v0.22.0-beta => ./vendor_local/btcd

replace github.com/btcsuite/btcd@latest => ./vendor_local/btcd

replace github.com/btcsuite/btcd/chaincfg/chainhash@v1.0.0 => ./vendor_local/btcd/chaincfg/chainhash

replace github.com/btcsuite/btcd/chaincfg/chainhash@v1.0.1 => ./vendor_local/btcd/chaincfg/chainhash
